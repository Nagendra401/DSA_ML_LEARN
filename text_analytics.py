...
from DSA_NLTK.amazon_scraper import amazon
...
from DSA_NLTK.twitter_scraper import get_tweets
...
stopwords_user_file = open("C:\\Users\\NAGENDRA_CHAPALA\\Documents\\7400618_810833986\\DataScienceCourse_TechEssential\\course\\DATA_SCIENCE_AUTHORITY\\week6_Python_TextAnalytics\\Text_Analytics\\1567077285_Data and stopwords\\Stopwords\\stopwords.txt")  # locate user defined stopwords list file.
...
document_term_matrix_ng = vectorizerng.fit_transform(clean_reviews_series)      # DOCUMENT-TERM-MATRIX
...
#Create DTM- with TF-IDF -- with log
...
#  word cloud
#  wordcloud using TFIDF of words
